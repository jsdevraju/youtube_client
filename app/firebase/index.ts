...
// File Upload
export const uploadFiles = async (storage:any, folder:any, files:any) => {
  ...
  const urlPromises = result.map((item: any) => {
...
export const forgotPassApi = async (auth:any, email:any) => {
  try {
...
// Collection Api
export const createCollection = async (db:any, collectionName:any, data:any) => {
  try {
...
export const updateCollection = async (db:any, collectionName:any, data:any) => {
  try {
...
export const deleteCollection = async (db:any, collectionName:any, data:any) => {
  try {
...
export const getCollections = async (db:any, collectionName:any) => {
  try {
    const data = [] as any;
...
export const getCollection = async (collectionName:any, db:any, id:any) => {
  try {
